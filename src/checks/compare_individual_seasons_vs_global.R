...
# What is the difference in other parameter fits when theta_lambda1 = 1 vs. 0?
...
# When Ri1/I10/R120 at highest likelihood values, little impact of theta_lambda1; when near "tail" of pars_top, higher theta_lambda1 leads to delayed peak
